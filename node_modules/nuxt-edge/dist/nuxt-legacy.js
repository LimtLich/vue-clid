/*!
 * nuxt-legacy-edge v2.2.0-25662131.e115890 (c) 2016-2018
...
var name = "nuxt-edge";
var version = "2.2.0-25662130.e115890";
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 7:
                ...
                layoutsFiles.forEach(function (file) {
                  var name = file.replace(new RegExp("^".concat(_this3.options.dir.layouts, "/")), '').replace(/\.(vue|js)$/, '');
